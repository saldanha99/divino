            ...
            <div className="container-custom grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        <Link href="https://www.instagram.com/divinolocacoesterraplenagem/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-yellow transition-colors"><Instagram className="w-5 h-5" /></Link>
                    </div>
                </div>
