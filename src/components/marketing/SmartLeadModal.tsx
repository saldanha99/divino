...
export default function SmartLeadModal({ isOpen, onClose, initialService }: SmartLeadModalProps) {
    const [step, setStep] = useState<Step>('SERVICE'); // Always start at SERVICE
    ...
    React.useEffect(() => {
        if (isOpen && initialService) {
            ...
            // We do NOT set step to DETAILS anymore, purposefully keeping it at SERVICE
            setStep('SERVICE');
        } else if (isOpen) {
            setStep('SERVICE');
        }
