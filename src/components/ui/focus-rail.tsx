        ...
        >
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <AnimatePresence mode="popLayout">
                    ...
                    >
                        {/* Main Background Image - deeply blurred */}
                        <img
                            src={activeItem.imageSrc}
                            alt=""
                            className="h-full w-full object-cover blur-[100px] saturate-[2]"
                        />
                        {/* Gradient Overlay - Unified, lighter at top for header integration */}
                        <div className="absolute inset-0 bg-gradient-to-t from-neutral-950 via-neutral-950/40 to-black/20" />

                        {/* Top Vignette for text readability, but distinct from general darkness */}
