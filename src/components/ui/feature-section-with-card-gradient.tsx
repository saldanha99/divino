...
export function FeatureCard({
    ...
    return (
        <div
            className="relative bg-gradient-to-b dark:from-neutral-900 from-neutral-100 dark:to-neutral-950 to-white p-6 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow"
        >
            <Grid size={20} />
