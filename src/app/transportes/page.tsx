                ...
                <div className="container-custom px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative h-[400px] rounded-[40px] overflow-hidden shadow-2xl">
                            <div className="absolute inset-0 bg-[url('https://blog.divinoterraplanagem.com.br/wp-content/uploads/2026/02/20230906_100705-scaled.jpg')] bg-cover bg-center"></div>
