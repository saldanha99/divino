                ...
                <div className="container-custom relative z-10 text-center text-white px-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center">
                        <SmartQuoteButton
                            ...
                            className="rounded-full bg-brand-yellow text-black hover:bg-white transition-all px-10 py-6 text-lg font-bold shadow-[0_0_40px_rgba(255,193,7,0.4)]"
                        >
            ...
            <section className="py-20 bg-white">
                <div className="container-custom px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="relative h-[500px] rounded-[40px] overflow-hidden shadow-2xl">
                        <div className="absolute inset-0 bg-[url('https://blog.divinoterraplanagem.com.br/wp-content/uploads/2026/02/IMG_9740-scaled.jpg')] bg-cover bg-center"></div>
                    ...
                    <div>
                        ...
                        <SmartQuoteButton
                            service="Terraplenagem"
                            className="w-full md:w-auto h-14 px-8 rounded-full bg-brand-dark text-white text-lg hover:bg-black shadow-lg"
                        >
