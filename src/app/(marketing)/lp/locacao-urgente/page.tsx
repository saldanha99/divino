    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 pb-20 font-sans">
            ...
            <div className="fixed bottom-0 left-0 w-full z-50 bg-green-600 p-4 md:hidden text-center shadow-[0_-5px_20px_rgba(0,0,0,0.2)]">
                <SmartQuoteButton
                    service="Locacao Urgente"
                    className="bg-transparent hover:bg-transparent text-white p-0 h-auto font-bold text-lg uppercase tracking-wide flex items-center justify-center gap-2"
                >
            ...
            <header className="relative bg-brand-dark text-white pt-24 pb-32 px-4 overflow-hidden">
                ...
                <div className="container-custom max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <SmartQuoteButton
                        service="Locacao Urgente"
                        className="inline-flex items-center justify-center bg-brand-confirm text-white font-bold text-xl px-10 py-8 rounded-full shadow-[0_0_30px_rgba(46,204,113,0.4)] transform hover:scale-105 transition-all hover:bg-green-500 border border-green-400"
                    >
